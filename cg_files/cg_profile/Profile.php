				  ...
				  <div class="carousel-inner" role="listbox">
                	...
                	<nav class="navbar navbar-default">
                        ...
                        <div class="navbar-header inline-block">
                          <a class="navbar-brands" href="#"><button type="button" style="position:absolute;" class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#ppc">Edit</button>
