...
error_reporting(1);
	...
	$que_user_info=mysqli_query($conn ,"select * from users where user_id=$vid");
...
<img src="../../cg_users/<?php echo $gender; ?>/<?php echo $email; ?>/Post/<?php echo $post_img_data[3]; ?>" style="height:500; width:800; ">
</div>
</div>
