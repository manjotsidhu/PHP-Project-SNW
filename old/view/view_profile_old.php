...
<table cellspacing="0">
<?php
	$que_post=mysqli_query($conn ,"select * from user_post where user_id=$v_user_id and priority='Public' order by post_id desc");
...
{
	header("location:../cg_profile/Profile.php");
}
?>
